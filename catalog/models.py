...
class Genre(models.Model):
    name = models.CharField(max_length=100, help_text="Введите жанр книги", verbose_name="Жанр книги")
...
class Author(models.Model):
    ...
    date_of_birth = models.DateField(help_text="Введите дату рождения", verbose_name="Дата рождения",
                                     default=date.today)
    date_of_death = models.DateField(help_text="Введите дату смерти", verbose_name="Дата смерти", default=date.today)
...
class BookInstance(models.Model):
    book = models.ForeignKey('Book', related_name='book_instances', on_delete=models.CASCADE, null=True)
    ...
    status = models.ForeignKey('Status', related_name='book_instances', on_delete=models.CASCADE, null=True,
    ...
    borrower = models.ForeignKey(
        ...
        help_text='Выберите заказчика из списка'
    )
